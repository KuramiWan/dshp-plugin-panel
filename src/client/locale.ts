...
export const zh = {
  ...
  'plugin.install.enabled': '添加后立即启用',
  'plugin.install.enabledHint': '默认不启用：只登记插件（显示为已停用），点「启用」才热挂载进宿主。',
  'plugin.notice.enabled': '已启用',
  'plugin.notice.disabled': '已停用',
  'plugin.notice.installedEnabled': '已新增并启用',
  'plugin.notice.installedDisabled': '已新增（未启用）',
  ...
  'plugin.help': '帮助',
  'plugin.version': '版本',
  'plugin.update.check': '检查更新',
  'plugin.update.checking': '检查中…',
  'plugin.update.updating': '更新中…',
  'plugin.update.available': '有新版本',
  'plugin.update.latest': '已是最新',
  'plugin.update.action': '更新',
  'plugin.update.all': '全部更新',
  'plugin.update.major.confirm': '检测到跨大版本更新（{cur} → {new}）。跨大版本可能包含不兼容变更。确定更新？',
  'plugin.update.confirm': '将把 {name} 更新到 {version}。确定？',
  'plugin.update.nonNpm': '非 registry 安装，仅展示差异',
  'plugin.update.restart': '已更新到 {version}，重启 DSH 后生效',
  'plugin.update.restartAll': '已更新，重启 DSH 后生效',
...
export const en = {
  ...
  'plugin.install.enabled': 'Enable immediately after adding',
  'plugin.install.enabledHint': 'Disabled by default: the plugin is only registered (shown as disabled); click "Enable" to hot-load it into the host.',
  'plugin.notice.enabled': 'Enabled',
  'plugin.notice.disabled': 'Disabled',
  'plugin.notice.installedEnabled': 'Added and enabled',
  'plugin.notice.installedDisabled': 'Added (disabled)',
  ...
  'plugin.update.check': 'Check for updates',
  'plugin.update.checking': 'Checking…',
  'plugin.update.updating': 'Updating…',
  'plugin.update.available': 'update available',
  'plugin.update.latest': 'up to date',
  'plugin.update.action': 'Update',
  'plugin.update.all': 'Update all',
  'plugin.update.major.confirm': 'A new major version is available ({cur} → {new}). Major updates may contain breaking changes. Update?',
  'plugin.update.confirm': 'Update {name} to {version}?',
  'plugin.update.nonNpm': 'Non-registry install; diff shown only',
  'plugin.update.restart': 'Updated to {version}; restart DSH to apply',
  'plugin.update.restartAll': 'Updated; restart DSH to apply',
