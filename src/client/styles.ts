...
.dshp-check{display:flex;align-items:center;gap:6px;font-size:12px;line-height:18px;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer}
.dshp-check input{accent-color:var(--dsw-alias-brand-primary,#2563eb);cursor:pointer}
